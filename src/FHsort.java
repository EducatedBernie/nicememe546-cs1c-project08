...
public class FHsort
{
    ...
    * @param left Leftmost of the array
    * @param right Rightmost of the array
    * @param <E> I don't know
    * @return
    */
   protected static < E extends Comparable< ? super E > >
   ...
   /**
    * The recursive version of quicksort
    * @param a The array itself
    * @param left Leftmost of the array
    * @param right Rightmost of the array
    * @param <E> I don't know
    ...
    * Public sort
    * @param a The array itself
    * @param <E> The type of generic object
    */
   public static < E extends Comparable< ? super E > >
   void quickSort( E[] a )
   {
